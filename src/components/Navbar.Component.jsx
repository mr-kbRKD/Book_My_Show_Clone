    ...
    <>
      <div className='text-white flex items-center justify-between'>
        <div>
          ...
          <span className='text-gray-400 text-xs flex items-center cursor-pointer hover:text-white'> Ambala Cantt <BiChevronDown /> </span>
        </div>
  ...
  return (
    <>
      <div className='container flex mx-auto px-4 items-center justify-between'>
        ...
        <span className='text-gray-200 text-base flex items-center cursor-pointer hover:text-white'>Ambala Cantt <BiChevronDown/></span>
